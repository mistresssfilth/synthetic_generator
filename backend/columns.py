...
fake_data_amt = 300 # Number of fake data points you want to generate

batch_size = 128 # Number of data points the GAN processes before updating weights

sample_size = 10 # Amount of data points processed in each epoch
...
export_location = "fake_data/fake_cc.csv"
