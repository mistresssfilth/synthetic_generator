...
#     # cc_scaled_data, col_max, cc_data = process_csv("cardio_train.csv")
#     # gan = GAN(cc_scaled_data, col_max)
#     # gan.train(epochs=200, batch_size=32, sample_size=300)
#
#     export_fakes(gan, "fake_data/fake_cc.csv", 300)
#     show_gen_loss(gan)
#     cc_sample_data = cc_data.sample(300)
#     real_vs_fake(cc_sample_data, gan.fake_data_list, 'age', 'cardio')
